...
if df_bruto is not None and df_binario is not None:
    ...
    try:
        ...
        with tabs4[1]:
            ...
            st.info("Ops... Parece que a geração usando a metodologia SIPP está liberada somente para assinantes")
            usar_score = False
        ...
        with tabs4[3]:  # Esta é agora a sua aba unificada de "Predição com IA"
            ...
            st.info('Ohh parece que o modelo completo esta liberado somente para assinates')
    except Exception as e:
