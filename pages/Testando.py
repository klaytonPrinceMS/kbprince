...
if df_bruto is not None and df_binario is not None:
    ...
    with tabs1[1]:
        ...
        st.dataframe(df_par_soma[['Concurso', 'Pares', 'Ímpares']].iloc[::-1], use_container_width=True, hide_index=True)
    # Substitua o bloco inteiro da aba "Tendências de Soma" por este:
    with tabs1[2]:
        ...
        fig.add_trace(go.Scatter(
            x=df_par_soma['Concurso'],
            y=df_par_soma['Soma'],
            mode='lines',
            name='Soma das Dezenas',
        ...
        fig.update_layout(
            title="Evolução da Soma das Dezenas com Bandas de Média",
        ...
        st.dataframe(df_par_soma[['Concurso', 'Soma']].iloc[::-1], use_container_width=True, hide_index=True)
    ...
    with tabs1[3]:
        ...
        fig = px.bar(
            ...
            labels={'Número': 'Dezena', 'Score': 'Pontuação de Tendência'},
            color_discrete_map={
                'Quente': COR_QUENTE,
                'Frio': COR_FRIO
            }
